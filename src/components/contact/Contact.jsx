...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm("service_tl7xljd","template_m4ibmbz", form.current, 'X6wbBcx4yOj6w8BA-')
        e.target.reset();
    };
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">natharpita2004@gmail.com</span>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">+91-7872128175</span>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">linkedin.com/in/arpita-nath-240949257</span>
